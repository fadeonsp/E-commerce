                ...
                <div class="d-flex align-items-center gap-4 filtro-bloco">
                    <div class="ordenacao">
                        <select class="form-select border-0">
                            <option selected>Ordenação padrao</option>
                            <option value="1">ordenação 1</option>
                            <option value="2">ordenação 2</option>  
                            <option value="3">ordenação 3</option>
                        </select>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="offset-md-1 col-md-3 mt-5">
                        ...
                        <p class="mb-0 text-muted">Preço: 
                            <i class="bi bi-currency-dollar me-2"></i>20 - 
                            <i class="bi bi-currency-dollar me-2"></i>1399
                        </p>
