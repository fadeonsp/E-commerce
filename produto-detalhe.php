    ...
    <section>
        <div class="container">
            <div class="row gap-4">
                ...
                <div class="col-md-6 detalhe-iphone">
                    <div>
                        <h2>Apple iphone 12 64gb</h2>
                        <i class="bi bi-currency-dollar me-2"> 1.200</i>
                    </div>
                    <form>
                        <label for="colorSelect text-muted mb-2">Cor</label>
                ...
                <div class="row categoria-descricao gap-4 mt-md-4">
                    <div class="col-5">
                        ...
                        <hr>
                        <p class="text-muted">Avaliaçãoes (0)</p>
                        <hr>
                    </div>
                    <div class="col-6">
                        ...
                        <p>
                            ...
                            iure cumque perspiciatis, asperiores alias architecto, aliquid deleniti 
                            beatae amet earum accusamus dolore excepturi harum nam. 
                        </p>
                    </div>
                </div>
